...
CREATE TABLE `meeting` (
  ...
  CONSTRAINT `mtLeader` FOREIGN KEY (`mtLeader`) REFERENCES `user` (`userNickname`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `meeting` VALUES ('독서모임',NULL,'독서','네동리우','주말마다 한 번씩 만나서 읽은 책에 대해 이야기합니다.','2022-05-09'),('축구',NULL,'축구','우리동네','슈웃골인!','2022-05-10');
